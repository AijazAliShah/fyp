        ...
        <form>
          ...
          <div>
            ...
            <table style={{ border: "1px solid black" }} className="detail">
              ...
              <tr>
                ...
                <td>1-10</td>
                <td rowSpan="5">
                  How clearly student identifies and summarizes main issues and
          ...
          <div>
            ...
            <table style={{ border: "1px solid black" }} className="detail">
              ...
              <tr>
                <td>How clearly has the student explained the Methodology?</td>
                <td>PLO-4 Investigation</td>
                <td>1-10</td>
                <td rowSpan="5">
                  How successfully the student explains how /why / which methods
                  are most relevant to the problem and also describes embedded
                  methods and possible alternative methods of working on the
                  problem?
                </td>
              </tr>
          ...
          <div>
            ...
            <table style={{ border: "1px solid black" }} className="detail">
              ...
              <tr>
                <td>How well have the students responded to the questions?</td>
                <td>PLO-10 Communication</td>
                <td>1-10</td>
                <td rowSpan="5">
                  How well the student assesses information in a meaningful way
                  and clearly answers the questions with accuracy, detail and
                  understanding?
                </td>
              </tr>
          ...
          <div>
            ...
            <table style={{ border: "1px solid black" }} className="detail">
              ...
              <tr>
                <td>
                  How do you grade the psychological contribution of the student
                  to the team?{" "}
                </td>
                <td>PLO-9 Individual and Team Work</td>
                <td>1-10</td>
            ...
            <table style={{ border: "1px solid black" }} className="detail">
              ...
              <tr>
                <td>
                  How do you grade the student’s communicational abilities as a
                  team member?
                </td>
                <td>PLO-10 Communication</td>
                <td>1-10</td>
                <td rowSpan="5">
                  The student adequately communicated information to other team
                  members.
                </td>
              </tr>
            ...
            <table style={{ border: "1px solid black" }} className="detail">
              ...
              <tr>
                <td>
                  Does the student have an idea of professional ethics relevant
                  to the project?
                </td>
                <td>PLO-8 Ethics</td>
                <td>1-10</td>
            ...
            <table style={{ border: "1px solid black" }} className="detail">
              ...
              <tr>
                ...
                <td>1-10</td>
                <td rowSpan="5">
                  The student understands legal responsibilities satisfactorily.
                </td>
              </tr>
