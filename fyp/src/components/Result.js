...
export class Mid extends Component {
  ...
  saveWeightage(){
    axios.post('http://localhost:3001/api/weightage',{
  ...
  render() {
    ...
    return (
      <div id="c_table">
                ...
                <input
                  ...
                  onChange={(e) =>
                    this.setState({
                      ...
                      weightmarks1:
                        e.target.value * this.state.eval1ObtainedPerc,
                    })
                  }
                ></input>
              </td>
                ...
                <input
                  ...
                  onChange={(e) =>
                    this.setState({
                      ...
                      weightmarks2:
                        e.target.value * this.state.eval2ObtainedPerc,
                    })
                  }
                ></input>
              </td>
                ...
                <input
                  ...
                  onChange={(e) =>
                    this.setState({
                      ...
                      weightmarks3:
                        e.target.value * this.state.eval3ObtainedPerc,
                    })
                  }
                ></input>
              </td>
                ...
                <input
                  ...
                  onChange={(e) =>
                    this.setState({
                      ...
                      weightmarks4:
                        e.target.value * this.state.eval4ObtainedPerc,
                    })
                  }
                ></input>
              </td>
        ...
        <br></br>
          <button type="submit" class="btn btn-primary" id="marks_submit_btn" onClick={() => this.saveWeightage()}>
            Save{" "}
          </button>
